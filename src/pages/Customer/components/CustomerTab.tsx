...
const CustomerTab = () => {
  const [formData, setFormData] = useState({
    ...
    guarantorEmail: "johnsmith@agp.com",
    ...
    <Grid2 container spacing={2}>
      <Grid2 size={6}>
        <Card variant="outlined" className="mb-3">
          <CardContent>
            <DetailCardHeader title="Applicant"></DetailCardHeader>
            <TextField
              label="ABN"
              name="abn"
              value={formData.abn}
        ...
        <Card variant="outlined">
          <CardContent>
            <DetailCardHeader title="Beneficial Owners"></DetailCardHeader>
            <TextField
              label="Name"
      ...
      <Grid2 size={6}>
        <Card variant="outlined">
          <CardContent>
            <DetailCardHeader title="Guarantor Details"></DetailCardHeader>
            <TextField
              label="Name"
              name="guarantorName"
